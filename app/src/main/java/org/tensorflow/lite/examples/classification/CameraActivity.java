...
public abstract class CameraActivity extends AppCompatActivity
  ...
  private CountDownTimer count = new CountDownTimer(3000, 1000) {
    ...
    public void onTick(long millisUntilFinished) {
      countdown.setText("-" + (1 + millisUntilFinished / 1000));
    }

    public void onFinish() {
      countdown.setText("Fall!");
      setPopUpView();
    }
  };
  private boolean countIsActive = false;
  private TextToSpeech t1;
  public boolean alertIsShowing = false;
  ...
  public void setPopUpView() {
    ...
    new AlertDialog.Builder(this)
            ...
            .setPositiveButton("Stop Allarm", new DialogInterface.OnClickListener() {
